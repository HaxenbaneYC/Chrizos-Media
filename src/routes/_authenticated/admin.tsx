  ...
  return (
    <Tabs defaultValue="overview" className="space-y-6">
      <TabsList className="glass-panel flex h-auto w-full flex-wrap justify-start gap-1 rounded-2xl p-1.5 text-foreground">
        <TabsTrigger value="overview" className="text-foreground/80 data-[state=active]:text-foreground">Overview</TabsTrigger>
        <TabsTrigger value="inquiries" className="text-foreground/80 data-[state=active]:text-foreground">Inquiries</TabsTrigger>
        <TabsTrigger value="team" className="text-foreground/80 data-[state=active]:text-foreground">Team &amp; Access</TabsTrigger>
        {isOwner ? <TabsTrigger value="settings" className="text-foreground/80 data-[state=active]:text-foreground">Website Settings</TabsTrigger> : null}
        {isOwner ? <TabsTrigger value="security" className="text-foreground/80 data-[state=active]:text-foreground">Security</TabsTrigger> : null}
      </TabsList>
